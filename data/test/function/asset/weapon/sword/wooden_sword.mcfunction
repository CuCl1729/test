...
data modify storage test: loot.item.id set from storage test: asset.wooden_sword.item

data modify storage test: loot.item.components set from storage test: asset.wooden_sword.components
