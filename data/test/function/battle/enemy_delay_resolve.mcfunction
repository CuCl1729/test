...
execute at @s as @e[tag=battle_member,tag=enemy,distance=..64] if score @s test.battle.id = #battle_turn test.battle.id if score @s test.battle.turn_order = #battle_turn test.battle.current_turn run function test:battle/enemy_ai/decide
