...
#                             5=魔法/アクティブスキルの2択待ち(チャット式)
#                             6=アクティブスキル選択待ち(チャット式)
...
execute if score @s test.battle.acting matches 1 if score @s test.battle.awaiting_skill matches 5 run function test:battle/ui/skill_category_poll
execute if score @s test.battle.acting matches 1 if score @s test.battle.awaiting_skill matches 6 run function test:battle/ui/active_skill_poll
