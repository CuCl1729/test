#> test:battle/ui/skill_category_minecart_choice_active
# @s = 「アクティブスキル」を選んだプレイヤー(トロッコ式)。同じカートのタグを付け替えて中身を作り替える
...
function test:battle/ui/active_skill_minecart_populate
