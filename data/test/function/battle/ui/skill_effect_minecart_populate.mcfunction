...
execute if score @s test.battle.skill_type matches 2 if score @s test.magic.known.atk matches 1 if score @s test.magic.select.atk matches 0 run data modify entity @n[tag=skill_effect_minecart] Items append value {Slot:1b,id:"redstone",count:1,components:{"minecraft:custom_name":{text:"[無効] 威力上昇",italic:false},"minecraft:custom_data":{test:{skill_effect:"atk"}}}}
execute if score @s test.battle.skill_type matches 2 if score @s test.magic.known.atk matches 1 if score @s test.magic.select.atk matches 1 run data modify entity @n[tag=skill_effect_minecart] Items append value {Slot:1b,id:"redstone",count:1,components:{"minecraft:custom_name":{text:"[有効] 威力上昇 ×1",italic:false,color:"green"},"minecraft:custom_data":{test:{skill_effect:"atk"}}}}
execute if score @s test.battle.skill_type matches 2 if score @s test.magic.known.atk matches 1 if score @s test.magic.select.atk matches 2 run data modify entity @n[tag=skill_effect_minecart] Items append value {Slot:1b,id:"redstone",count:1,components:{"minecraft:custom_name":{text:"[有効] 威力上昇 ×2",italic:false,color:"green"},"minecraft:custom_data":{test:{skill_effect:"atk"}}}}
execute if score @s test.battle.skill_type matches 2 if score @s test.magic.known.atk matches 1 if score @s test.magic.select.atk matches 3 run data modify entity @n[tag=skill_effect_minecart] Items append value {Slot:1b,id:"redstone",count:1,components:{"minecraft:custom_name":{text:"[有効] 威力上昇 ×3",italic:false,color:"green"},"minecraft:custom_data":{test:{skill_effect:"atk"}}}}
