...
data remove entity @n[tag=skill_minecart] Items
...
data modify entity @n[tag=skill_minecart] Items append value {Slot:8b,id:"ender_eye",count:1,components:{"minecraft:custom_name":{text:"決定する",italic:false},"minecraft:custom_data":{test:{skill_choice:"confirm"}}}}
