give @s red_dye[custom_data={test:{magic:{effect:fire}}},custom_name={text:"魔法要素: 火",italic:false}]
give @s golden_apple[custom_data={test:{magic:{effect:heal}}},custom_name={text:"魔法要素: 回復",italic:false}]
give @s snowball[custom_data={test:{magic:{type:projectile}}},custom_name={text:"魔法要素: 投射",italic:false}]
