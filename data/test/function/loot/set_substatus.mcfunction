...
$data modify storage test: loot.item.components."minecraft:lore" append from storage test: loot.table.substatusName[$(substatus)]
data modify storage test: loot.item.components."minecraft:lore"[-1] prepend value {text:"       "}
