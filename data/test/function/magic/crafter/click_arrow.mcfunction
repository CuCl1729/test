#> test:magic/crafter/click_arrow
# @s = クラフター本体。@macro dir: -1(前へ)/ 1(次へ)
...
execute store result score #page test.buff.work run data get entity @s data.crafter_ui.page
...
execute store result entity @s data.crafter_ui.page int 1 run scoreboard players get #page test.buff.work
